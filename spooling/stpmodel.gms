...
# Declare options
#===============================================================================
options optcr=1.e-5, optca=1.e-5, limrow=0, limcol=0, reslim= 1200;
...
line.nd = 6;
line.nw = 18;
put_utility line 'msg' / stpmodel.objval ' ' stpmodel.objest ' ' stpmodel.resusd 
re ' ' ae;
line.nd = 0;
put_utility line 'msg' / stpmodel.solvestat ' ' stpmodel.nodusd ' ' 
(stpmodel.numvar-1) ' ' nlts ' ' (stpmodel.numequ-nlts-1) ' ' nlts;
