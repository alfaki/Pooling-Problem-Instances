...
line.nd = 6;
line.nw = 18;
put_utility line 'msg' / pqmodel.objval ' ' pqmodel.objest ' ' pqmodel.resusd 
' ' re ' ' ae;
line.nd = 0;
put_utility line 'msg' / pqmodel.solvestat ' ' pqmodel.nodusd ' ' 
(pqmodel.numvar-1) ' ' nlts ' ' (pqmodel.numequ-nlts-1) ' ' nlts;
