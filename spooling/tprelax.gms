...
scalars ae, re;
ae = abs(tprelax.objval - tprelax.objval);
re = ae/abs(tprelax.objval);
file line;
put_utility line 'msg' / '#####' ' Solution Summary #####';
line.nd = 6;
line.nw = 18;
put_utility line 'msg' / tprelax.objval ' ' tprelax.objval ' ' tprelax.resusd 
' ' re ' ' ae;
line.nd = 0;
put_utility line 'msg' / tprelax.solvestat ' ' tprelax.iterusd ' ' 
(tprelax.numvar-1) ' ' 0 ' ' (tprelax.numequ-1) ' ' 0;
